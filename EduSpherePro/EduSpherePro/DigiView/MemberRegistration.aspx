<%@ Page Title="" Language="C#" MasterPageFile="~/DigiView/DigiViewSite.Master" AutoEventWireup="true" CodeBehind="MemberRegistration.aspx.cs" Inherits="EduSpherePro.DigiView.MemberRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="locationField">
        <asp:TextBox id="autocomplete" ClientIDMode="static" clientID="autocomplete" placeholder="Enter your address"
             onFocus="geolocate()" type="text" runat="server"></asp:TextBox>
