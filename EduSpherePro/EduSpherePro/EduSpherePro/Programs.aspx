<%@ Page Title="" Language="C#" MasterPageFile="~/EduSpherePro/EduSpherePro.Master" Async="true" AutoEventWireup="true" CodeBehind="Programs.aspx.cs" Inherits="EduSpherePro.EduSpherePro.Programs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
					    ...
					    <ul class="nav ace-nav">
						    <li class="light-blue dropdown-modal">
							    ...
							    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						            <li>
                                        <asp:LinkButton ID="lnkBtnViewPrograms"   OnCommand="ManageVisibility" CommandName="ViewPrograms" CommandArgument="" Text='<i class="ace-icon fa fa-eye fa-fw"></i> Add Programs' runat="server"></asp:LinkButton>
								    </li>
								    <li class="divider"></li>
								    <li>
									    <asp:LinkButton ID="lnkBtnViewCourses"    OnCommand="ManageVisibility" CommandName="ViewCourses" CommandArgument="" Text='<i class="ace-icon fa fa-eye"></i> Add Courses & Questions' runat="server"></asp:LinkButton>
								    </li>
                                    <li class="divider"></li>
								    <li>
									    <asp:LinkButton ID="lnkBtnLearningContent"  OnCommand="ManageVisibility" CommandName="AddLearning" Text='<i class="ace-icon fa fa-plus"></i> Add Learning Resources' runat="server"></asp:LinkButton>
								    </li>
                                    <li class="divider"></li>
                                    <li>
									    <asp:LinkButton ID="lnkBtnBatches"  OnCommand="ManageVisibility" CommandName="AddBatch" Text='<i class="ace-icon fa fa-eye"></i> Create Batches' runat="server"></asp:LinkButton>
								    </li>
                                    <li class="divider"></li>
                                    <li>
									    <asp:LinkButton ID="lnkBtnAssessments"  OnCommand="ManageVisibility" CommandName="ViewAssessments" Text='<i class="ace-icon fa fa-eye"></i>  Create Assessments' runat="server"></asp:LinkButton>
								    </li>
                                    <li class="divider"></li>
                                    <li>
									    <asp:LinkButton ID="lnkBtnStudentAttendance"  OnCommand="ManageVisibility" CommandName="StudentAttendance" Text='<i class="ace-icon fa fa-signal"></i> Mark Student Attendance' runat="server"></asp:LinkButton>
								    </li>
                                    <li class="divider"></li>
							    </ul>
						    </li>
  ...
  <!--end Page Command Buttons--> 
   ...
   <!--Add Learning Artifacts for a Course-->     
   <div class="row">
            <div class="col-xs-12">
                        ...
                        <caption>Enter Artifact Details</caption>
                            ...
                            <tr>
                               <td>Artifact Type:</td><td><asp:DropDownList ID="ddlArtifactType" runat="server">
                                                                    ...
                                                                    <asp:ListItem>VideoLecture</asp:ListItem>
                                                                </asp:DropDownList></td>
                                <td>Title :</td><td><asp:TextBox ID="txtBoxArtifactTitle" runat="server"></asp:TextBox></td>
                               </tr>
                              <tr>
                                  <td>Description:</td><td colspan="3"><asp:TextBox CssClass="col-sm-10 col-xs-10" ID="txtBoxDescription"  TextMode="MultiLine" runat="server"></asp:TextBox></td>
                              </tr>
                                    <tr>      
                                     ...
                                     <td><asp:Button  class="btn btn-1" Text="Click to Upload" OnClick="UploadFile" runat="server" />
                                         <asp:Button  class="btn btn-1" Text="BlobUpload-Test" OnClick="UploadToBlobStorage" runat="server" />
                                     </td> 
                                     </tr>
                                     <tr>
                                     <td></td>
                                         <td>
                                         <asp:LinkButton ID="lnkBtnInsertLearningResource"  class="btn btn-white btn-info btn-bold" Text="<i class='ace-icon fa fa-floppy-o bigger-120 blue'>Save</i>" ToolTip="Save" OnClick="InsertRecord" runat="server" ></asp:LinkButton>
  ...
  <div class="row">
            ...
            <!--Panel to Display Artifacts of selected course-->
             <asp:Panel ID="pnlCourseDocs"  ScrollBars="auto"  Height="400px"   runat="server">
              <asp:Label ID="lblSelectedCourseID" runat="server"></asp:Label>   
          <div class="col-sm-10 widget-container-col" id="widget-container-col-10">
                    <div class="widget-box" id="widget-box-10">
                       <div class="widget-header widget-header-small">
                            ...
                            <div class="widget-main padding-6">
								<div class="tab-content">
                                    <div id="videos" class="tab-pane in active">
                                        <div class="row">
                                             <div class="col-xs-12">
                                                  <asp:GridView ID="gvCourseVideos" DataKeyNames="VideoID"  CssClass="table table-hover table-bordered" AlternatingRowStyle-BackColor="Silver" HorizontalAlign="left" AutoGenerateColumns="false" BorderWidth="1" CellPadding="4" GridLines="both" 
                                                    BackColor="White" OnRowDeleting="gvCourseVideos_RowDeleting" BorderColor="#3366CC" BorderStyle="None" AllowSorting="true"   AllowPaging="false"  PagerStyle-Mode="NumericPages" PageSize="100" RowStyle-HorizontalAlign="left" runat="server">
                           
                                                    <RowStyle Font-Names="Arial" Font-Size="10pt" ForeColor="#003399" ></RowStyle>
                                                    <Columns>
                                                        <asp:CommandField ShowDeleteButton="true"  />
                                                        <asp:BoundField DataField="VideoID" HeaderText="Video ID"  ></asp:BoundField>
                                                        <asp:BoundField DataField="VideoPath" HeaderText="Loc"  ></asp:BoundField>
                                    ...
                                    <div id="docs" class="tab-pane">
                                        ...
                                        <div class="row">
                                           <div class="col-xs-12">
                                              <asp:GridView ID="gvCourseDocs" DataKeyNames="DocID" OnRowDeleting="gvCourseDocs_RowDeleting" CssClass="table table-hover table-bordered"  AutoGenerateColumns="false" AlternatingItemStyle-BackColor="Gainsboro"   
                                                  CellPadding="2" GridLines="None"  AllowPaging="true" runat="server">
                                                    <HeaderStyle Font-Names="Arial" Font-Italic="true" Font-Size="12pt" Font-Bold="false"  BackColor="#465c71" ForeColor="#FFFFFF"  />
                                                                        <RowStyle Font-Names="Arial" Font-Size="10pt" ForeColor="#003399" ></RowStyle>
                                                    <Columns>
                                                        <asp:CommandField ShowDeleteButton="true"  />
                                                        <asp:BoundField DataField="DocID" HeaderText="Artifcat ID"  ></asp:BoundField>
                                                        <asp:BoundField DataField="CourseTitle" HeaderText="Course"  ></asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="ArtifactPath" HeaderText=""  ></asp:BoundField>
                                                    </Columns>
                                                     <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                                                    <PagerStyle BackColor="#99CCCC" ForeColor="#003399" HorizontalAlign="Left" />
                                                    <SelectedRowStyle BackColor="#009999" Font-Bold="True" ForeColor="#CCFF99" />
