                ...
                <asp:Panel ID="pnlViewOrganizations" ScrollBars="Auto"  runat="server">
                    <!--Filter Organizations-->
                     <div class="col-xs-12">
                        <table>
                            <tr>
                                <th class="col-sm-2">Organization Type</th><td class="col-sm-2"><asp:DropDownList ID="ddlFilterOrganizationType" runat="server">
                                                                                                            <asp:ListItem>TREATMENT-CENTRE</asp:ListItem>
                                                                                                            <asp:ListItem>EDUCATION-CENTRE</asp:ListItem>
                                                                                                            <asp:ListItem>EMPLOYER</asp:ListItem>
                                                                                                            <asp:ListItem>VENDOR</asp:ListItem>
                                ...
                                <td class="col-sm-2"><asp:LinkButton ID="btnFilterOrganizationType"  class="btn btn-xs btn-info" Text="<i class='ace-icon fa fa-filter bigger-120'> GO</i>" ToolTip="Filter Org Type" OnCommand="ManageOrganizationVisibility" CommandName="FilterOrganizationType" CommandArgument="" runat="server" ></asp:LinkButton></td>
                            </tr>
                        </table>
                    </div><hr />
                <div class="col-xs-12">
                    <asp:DataList ID="dlOrganizations" DataKeyField="OrganizationId" HorizontalAlign="Justify"   RepeatColumns="1" RepeatDirection="vertical" GridLines="Vertical" runat="server">
                        <HeaderTemplate>
                            <table id="simple-table" class="table  table-bordered table-hover">
                                ...
                                <tr>
                                        ...
                                        <th colspan="2"><asp:Label Width="100px" Text=Organization runat="server"></asp:Label></th>
                                        <th colspan="1"><asp:Label Width="100px" Text="HOD" runat="server"></asp:Label></th>
										<th colspan="1"><asp:Label Width="100px" Text="Contact Person" runat="server"></asp:Label></th>
										<th colspan="1"><asp:Label Width="100px" Text="Phone" runat="server"></asp:Label> </th>
										<th colspan="1"><asp:Label Width="200px" Text="Email" runat="server"></asp:Label></th>
										<th colspan="1"><asp:Label Width="50px" Text="Bank" runat="server"></asp:Label></th>
									</tr>
                                    </thead>
                              </table>
                        </HeaderTemplate>
                        ...
                        <ItemTemplate>
                             <table id="simple-table" class="table  table-bordered table-hover">
									<tr>
                                        <td colspan="1"><asp:Label Width="50px" class="label label-sm label-warning" Text=<%#Eval("OrganizationId") %> runat="server"></asp:Label></td>
                                        <td colspan="1"><asp:Label Width="80px" Text=<%# DataBinder.Eval(Container.DataItem,"OrganizationType")%> runat="server"></asp:Label></td>
                                        <td colspan="1"><asp:LinkButton  Width="20px" ID="btnViewOrganizationDetails"  class="green bigger-140 show-details-btn" Text="<i class='ace-icon fa fa-angle-double-down bigger-120'></i>" ToolTip="Profile" OnCommand="ManageOrganizationVisibility" CommandName="ViewProfile" CommandArgument='<%#Eval("OrganizationId") %>' runat="server" ></asp:LinkButton></td>
                                        <td colspan="2"><asp:Label Width="100px" Text=<%# DataBinder.Eval(Container.DataItem,"OrganizationName")%> runat="server"></asp:Label></td>
                                        <td colspan="1"><asp:Label Width="100px" Text=<%# DataBinder.Eval(Container.DataItem,"ManagerName")%> runat="server"></asp:Label></td>
										<td colspan="1"><asp:Label Width="100px" Text=<%# DataBinder.Eval(Container.DataItem,"ContactPerson")%> runat="server"></asp:Label></td>
										<td colspan="1"><asp:Label Width="100px" Text=<%# DataBinder.Eval(Container.DataItem,"PhoneOne")%> runat="server"></asp:Label> </td>
										<td colspan="1"><asp:Label Width="250px" Text=<%#DataBinder.Eval(Container.DataItem,"Email") %> runat="server"></asp:Label></td>
										<td colspan="1">
